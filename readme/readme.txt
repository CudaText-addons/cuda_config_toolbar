...
1) Choose icon set, for standard buttons. Many icon sets shipped in plugin.
...
- command: usual CudaText commands or plugin commands allowed, you can choose both in dialog like Commands dialog
